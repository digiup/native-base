...
export default function Overlays() {
  ...
  const [removed, setRemoved] = createSignal([]);
    ...
    <section data-stack="">
      ...
      <article data-card="">
        <header>
          ...
          <p>The dialog is markup; only the row being confirmed is a signal.</p>
        </header>
        <div data-row="">
          <For each={TEAM.filter((member) => !removed().includes(member.name))}>
            {(member) => (
      ...
      <dialog ref={confirm} on:close={onClose} closedby="any" aria-labelledby="confirm-title">
        <header>
